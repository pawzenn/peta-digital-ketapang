...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-neutral-900">Tambah UMKM</h1>
    ...
    <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex gap-3">
                <button class="inline-flex items-center rounded-lg bg-emerald-800 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-900">Simpan</button>
