...
@section('page_subtitle', 'Perbarui nama kategori UMKM')

@section('content')
<div class="max-w-2xl mx-auto space-y-6">

    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-neutral-900">Edit Kategori UMKM</h1>
    ...
    <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.kategori-umkm.update', $kategori) }}" class="space-y-6">
            @csrf
            @method('PUT')
