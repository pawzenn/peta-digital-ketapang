...
<div class="bg-neutral-950 py-16 text-white">
    <div class="mx-auto max-w-6xl px-6">
        ...
        <a href="/homestay" class="text-sm text-white/70 hover:text-white">← Kembali</a>
        ...
        <div class="relative mt-6 overflow-hidden rounded-2xl">
            ...
            <div class="absolute inset-y-0 right-0 flex w-full max-w-md flex-col justify-center px-8">
                <h1 class="font-serif text-3xl font-bold">{{ $homestay->nama }}</h1>

                <div class="mt-3">
                    <x-public.rating-badge :rating="$homestay->rating" />
                </div>
